    ...
    >
      ...
      >
        <div className="flex items-center gap-1.5 flex-wrap justify-center">
          ...
          <a href="tel:+971504190737" className="hover:underline transition-colors font-medium">
            +971 50 419 0737
          </a>
          <span className="opacity-55">,</span>
          <a href="tel:+971586490737" className="hover:underline transition-colors font-medium">
            +971 58 649 0737
          </a>
          <span className="opacity-55">,</span>
          <a href="tel:+97145726991" className="hover:underline transition-colors font-medium">
            +971 4 5726991 <span className="text-[9px] opacity-75">Ext: 159</span>
          </a>
        </div>
      ...
      <div className="px-6 md:px-12 flex justify-between items-center py-4">
        <Link to="/" className="flex items-center gap-2 group">
          <img
            ...
            className={`h-10 md:h-[48px] w-auto object-contain transition-all duration-300 ${
          ...
          <img
            ...
            className={`h-7.5 md:h-[34px] w-auto object-contain transition-all duration-300 ${
              !solid && "brightness-0 invert"
            }`}
          />
        </Link>
      ...
      {open && (
        <div className="lg:hidden bg-canvas text-brand border-t border-brand/10 px-6 py-8 flex flex-col gap-5">
          <Link to="/" onClick={() => setOpen(false)} className="text-sm uppercase tracking-widest">
            Home
          </Link>
          <Link
            to="/about"
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="pl-4 flex flex-col gap-3.5 border-l border-brand/10">
              <Link
                to="/tour-packages"
                onClick={() => setOpen(false)}
                className="text-xs uppercase tracking-widest text-brand/80"
              >
                Tour Packages
              </Link>
              <Link
