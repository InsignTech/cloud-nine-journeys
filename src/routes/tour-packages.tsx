  ...
  head: () => ({
    meta: [
      { title: "Tours & Packages — Cloud Life Travels" },
      {
        name: "description",
        content:
          "Explore curated tours across Dubai, Abu Dhabi, Ras Al Khaimah, Al Ain, Fujairah, Oman-Musandam, and Salalah.",
      },
...
const tours = [
    ...
    images: [
      {
        ...
        caption: "Burj Khalifa & Downtown",
      },
      {
        src: "https://images.unsplash.com/photo-1582672060674-bc2bd808a8b5?auto=format&fit=crop&w=600&q=80",
        caption: "The Dubai Frame",
      },
      { src: dubaiMarinaSkyline, caption: "Dubai Marina Skyline" },
      {
        src: "https://images.unsplash.com/photo-1583212292454-1fe6229603b7?auto=format&fit=crop&w=600&q=80",
  ...
  },
  {
    ...
    images: [
      ...
      {
        src: "https://images.unsplash.com/photo-1618083707368-b3823daa2726?auto=format&fit=crop&w=600&q=80",
    ...
    images: [
      {
        ...
        caption: "Jebel Hafeet Ridge",
      },
      {
        src: "https://images.unsplash.com/photo-1584132967334-10e028bd69f7?auto=format&fit=crop&w=600&q=80",
        caption: "Al Ain Oasis Canopy",
      },
      {
        src: "https://images.unsplash.com/photo-1627856013091-fed6e4e30025?auto=format&fit=crop&w=600&q=80",
        caption: "Al Jahili Fortification",
      },
      {
        src: "https://images.unsplash.com/photo-1473448912268-2022ce9509d8?auto=format&fit=crop&w=600&q=80",
        caption: "Green Mubazzarah Springs",
      },
    ],
  },
  {
    ...
    images: [
      {
        ...
        caption: "Limestone Fjord Cliffs",
      },
      {
        src: "https://images.unsplash.com/photo-1602491453631-e2a5ad90a131?auto=format&fit=crop&w=600&q=80",
        caption: "Dhow Boat Excursion",
      },
      {
        src: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=600&q=80",
        caption: "Snorkeling Channels",
      },
      {
        src: "https://images.unsplash.com/photo-1551244072-5d12893278ab?auto=format&fit=crop&w=600&q=80",
        caption: "Musandam Dolphin Pods",
      },
    ],
  },
  {
          ...
          {images.map((img, idx) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white flex flex-col">
                <span className="text-[8px] uppercase tracking-widest text-accent font-bold mb-1.5">
                  Attraction
                </span>
      ...
      <main className="bg-canvas text-brand">
        <PageHero
          ...
          title={
            <>
              Bespoke local <br />
              <span className="not-italic">adventures.</span>
            </>
          }
        ...
        <section className="py-32 px-6 md:px-10">
          <div className="max-w-7xl mx-auto space-y-32">
            {tours.map((t) => (
              <article
                key={t.id}
                className="border-b border-brand/5 pb-24 last:border-b-0 last:pb-0"
              >
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-start mb-12">
                  ...
                  <div className="text-brand/80 font-light leading-relaxed text-sm md:text-base space-y-4">
                    ...
                    <div className="pt-2">
                      <Link
                        to="/contact"
                        className="inline-flex items-center gap-1.5 eyebrow text-accent border-b border-accent/25 pb-1 hover:border-accent font-bold"
                      >
