  ...
  head: () => ({
    meta: [
      { title: "UAE & Global Visa Services — Cloud Life Travels" },
      {
        name: "description",
        content:
          "Apply for UAE tourist visas, multiple-entry permits, and airport visa changes. Direct support from premium visa experts.",
      },
      { property: "og:title", content: "Visa Services — Cloud Life Travels" },
      {
        property: "og:description",
        content:
          "Easily apply for UAE tourist and multiple visas online. Reliable end-to-end concierge services.",
      },
    ],
  }),
  component: Visas,
      ...
      <main className="bg-canvas text-brand">
        <PageHero
          ...
          title={
            <>
              Explore beyond <br />
              <span className="not-italic text-accent">borders.</span>
            </>
          }
        ...
        <section className="py-24 px-6 md:px-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-brand/80 font-light leading-relaxed text-base md:text-lg max-w-2xl mx-auto">
              Our travel specialists manage your entire visa submission process with ultimate
              accuracy and efficiency. Whether you require standard tourist visas or complex entry
              permit changes, we ensure a seamless experience.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-brand/60 font-light text-sm max-w-xl mx-auto mt-3">
                Choose the perfect duration for your trip. Speak with our concierge team for
                immediate end-to-end processing.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                <div>
                  <span className="text-[10px] tracking-[0.2em] uppercase font-bold text-brand/40">
                    Short Getaway
                  </span>
                  <div className="flex items-baseline gap-2 mt-4 mb-6">
                    <span className="font-serif text-5xl md:text-6xl font-bold text-brand leading-none">
                      14
                    </span>
                    <span className="text-xs text-brand/50 font-light uppercase tracking-wider font-sans">
                      Days Visa
                    </span>
                  </div>
              ...
              >
                ...
                <div>
                  <span className="text-[10px] tracking-[0.2em] uppercase font-bold text-canvas/40">
                    Standard Leisure
                  </span>
                  <div className="flex items-baseline gap-2 mt-4 mb-6">
                    <span className="font-serif text-5xl md:text-6xl font-bold text-canvas leading-none">
                      30
                    </span>
                    <span className="text-xs text-canvas/60 font-light uppercase tracking-wider font-sans">
                      Days Visa
                    </span>
                  </div>
        ...
        <section className="py-32 px-6 md:px-10 bg-brand/[0.01] border-y border-brand/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              ...
              <p className="text-brand/80 font-light text-sm mt-3 max-w-xl mx-auto">
                Please carefully review the required documentation and procedures below.
              </p>
            </div>
              ...
              <div className="bg-white border border-brand/10 shadow-[0_4px_24px_rgba(33,30,50,0.02)] p-8 rounded-none transition-all hover:border-accent/40 flex flex-col justify-between">
                <div>
                  <div className="mb-6 flex items-center justify-between">
                    ...
                    <span className="text-xs text-brand/100 tracking-wider">
                      01 / Required Files
                    </span>
                  </div>
                  ...
                  <ul className="text-sm font-light text-brand/85 space-y-4">
                    <li className="flex items-start gap-2.5">
                      ...
                      <span>
                        <strong className="font-medium text-brand">Passport Copy:</strong> Must have
                        at least 6 months validity from the planned date of entry in the UAE.
                      </span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                      <span>
                        <strong className="font-medium text-brand">Photograph:</strong> Passport
                        size photo taken against a clear white background.
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="text-sm font-light text-brand/85 space-y-4">
                    <li className="flex items-start gap-2.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                      <span>
                        Children traveling with family require a valid birth certificate copy.
                      </span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                      <span>
                        Married couples with different last names must present a marriage
                        certificate.
                      </span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                      <span>
                        To apply for a tourist visa, spouses below 30 years of age require a
                ...
                <div>
                  ...
                  <ul className="text-sm font-light text-brand/85 space-y-4">
                    <li className="flex items-start gap-2.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                      <span>
                        Dubai Airport Authorities conduct random eye screening for incoming
                        visitors.
                      </span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                      <span>
                        Visitors must present a printed hard copy of their visa or a printed visa
                        number confirmation at the eye screening counter.
                      </span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                      <span>
                        If you fail to bring a copy, a charge of{" "}
                        <strong className="font-medium text-brand">AED 30</strong> per copy applies
                        (payable strictly in AED).
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-white border border-brand/10 shadow-[0_4px_24px_rgba(33,30,50,0.02)] p-8 rounded-none transition-all hover:border-accent/40 flex flex-col justify-between lg:col-span-1 lg:col-start-1">
                <div>
                  ...
                  <p className="text-xs font-light text-brand/85 mb-4">
                    Additional identity documents are mandatory for visitors of the following
                    nationalities:
                  </p>
                  <ul className="text-sm font-light text-brand/85 space-y-3.5 pl-1">
                    <li className="flex items-center gap-3">
                      ...
                      <span>
                        <strong className="font-medium text-brand">Afghanistan:</strong> National
                        identity card
                      </span>
                    </li>
                    <li className="flex items-center gap-3">
                      <span className="w-2 h-2 bg-accent/40" />
                      <span>
                        <strong className="font-medium text-brand">Iran:</strong> National ID card
                        (Kart Shinasaei Milli)
                      </span>
                    </li>
                    <li className="flex items-center gap-3">
                      <span className="w-2 h-2 bg-accent/40" />
                      <span>
                        <strong className="font-medium text-brand">Iraq:</strong> National identity
                        card
                      </span>
                    </li>
                    <li className="flex items-center gap-3">
                      <span className="w-2 h-2 bg-accent/40" />
                      <span>
                        <strong className="font-medium text-brand">Pakistan:</strong> National
                        identity card
                      </span>
                    </li>
                  </ul>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 text-sm font-light text-brand/85">
                    <ul className="space-y-4">
                      <li className="flex items-start gap-2.5">
                        <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                        <span>
                          Non-standard passport holders (e.g., diplomatic) must contact the local
                          embassy/consulate of the destination for specific rules.
                        </span>
                      </li>
                      <li className="flex items-start gap-2.5">
                        <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                        <span>
                          All issued visas have a{" "}
                          <strong className="font-medium text-brand">60-day grace period</strong> to
                          enter Dubai from the date of issuance.
                        </span>
                      </li>
                      <li className="flex items-start gap-2.5">
                        <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                        <span>
                          Visa application fees are completely{" "}
                          <strong className="font-medium text-brand">non-refundable</strong>.
                        </span>
                      </li>
                    </ul>
                    <ul className="space-y-4">
                      <li className="flex items-start gap-2.5">
                        <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                        <span>
                          The visa sponsor is legally and financially responsible for a visitor's
                          overstay liabilities.
                        </span>
                      </li>
                      <li className="flex items-start gap-2.5">
                        <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                        <span>
                          Actual entry to the UAE is subject to final immigration approval.
                        </span>
                      </li>
                    </ul>
                  </div>
        ...
        <section className="py-32 px-6 md:px-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              ...
              <p className="text-brand/55 font-light text-sm mt-3">
                Premium entry modification and transit services engineered for absolute comfort.
              </p>
            </div>
                ...
                <div>
                  ...
                  <div className="p-8">
                    ...
                    <p className="text-sm font-light text-brand/70 leading-relaxed">
                      Designed for frequent business executives and leisure travelers. Allows highly
                      flexible, seamless and continuous movement in and out of the UAE.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-canvas border border-brand/5 overflow-hidden flex flex-col justify-between group hover:border-accent/20 transition-all">
                <div>
                  ...
                  <div className="p-8">
                    ...
                    <p className="text-sm font-light text-brand/70 leading-relaxed">
                      Extend or change your UAE tourist visa instantly directly at the airport
                      terminal. Fast, stress-free transfers without returning to your home country.
                    </p>
                  </div>
                </div>
                <div className="mx-8 mb-8 pt-6 border-t border-brand/5 flex items-center justify-between text-accent">
              ...
              <div className="bg-canvas border border-brand/5 overflow-hidden flex flex-col justify-between group hover:border-accent/20 transition-all">
                <div>
                  ...
                  <div className="p-8">
                    ...
                    <p className="text-sm font-light text-brand/70 leading-relaxed">
                      Economical visa change options via comfortable regional transfers. Full
                      logistics, documentation, and boundary crossing assistance provided.
                    </p>
                  </div>
                </div>
                <div className="mx-8 mb-8 pt-6 border-t border-brand/5 flex items-center justify-between text-accent">
        ...
        <section className="py-32 px-6 md:px-10 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="font-serif text-4xl md:text-6xl mb-6">We Are Waiting For Your Call</h2>
            <p className="text-brand/60 max-w-xl mx-auto text-base font-light mb-12">
              Speak directly with our expert team to secure the absolute best offers, special
              pricing, and expedited turnaround times for your UAE tourist or business visa.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
              <a
                href="tel:+971504190737"
                className="flex items-center gap-3 bg-brand/5 border border-brand/10 hover:border-accent/40 px-6 py-4 transition-colors"
              >
                <span className="bg-accent/15 p-2 rounded-full text-accent">
