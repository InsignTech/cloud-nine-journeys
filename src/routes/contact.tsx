            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="font-sans text-sm text-brand/80 leading-relaxed max-w-sm">
                  3rd Floor, Office# 059, Sultan Business Centre,<br />
              ...
              <div>
                ...
                <div className="font-sans text-sm text-brand/85 space-y-1.5">
                  <p className="flex items-center gap-2">
                    <span className="text-[10px] text-brand/40 uppercase tracking-widest w-14">Mobile</span>
                    <a href="tel:+971504190737" className="hover:text-accent font-medium tracking-wide transition-colors">
                      +971 50 419 0737
                    </a>
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="text-[10px] text-brand/40 uppercase tracking-widest w-14">Mobile</span>
                    <a href="tel:+971586490737" className="hover:text-accent font-medium tracking-wide transition-colors">
                      +971 58 649 0737
                    </a>
                  </p>
                  <p className="flex items-center gap-2">
                    <span className="text-[10px] text-brand/40 uppercase tracking-widest w-14">Office</span>
                    <a href="tel:+97145726991" className="hover:text-accent font-medium tracking-wide transition-colors">
                      +971 4 5726991
                    </a>
              ...
              <div>
                ...
                <p className="font-sans text-sm text-brand/85">
                  <a href="mailto:info@cloudlifetravels.com" className="hover:text-accent font-medium transition-colors">
