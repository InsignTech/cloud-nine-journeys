  ...
  head: () => ({
    meta: [
      { title: "Cloud Life Travels — Bespoke Luxury Travel & Visas" },
      {
        name: "description",
        content:
          "Bespoke Dubai experiences, curated tour packages and visa concierge for the discerning global traveler.",
      },
      { property: "og:title", content: "Cloud Life Travels" },
      {
        property: "og:description",
        content: "Bespoke Dubai experiences and curated journeys worldwide.",
      },
    ],
  }),
  component: Index,
...
const activities = [
  {
    title: "Celestial Desert Safaris",
    tag: "Activities / Private Tour",
    img: desertDawn,
    alt: "Hot air balloons over Arabian dunes at dawn",
  },
  {
    title: "Dubai City Tours",
    tag: "Activities / Guided Tour",
    img: skyline,
    alt: "Tourists visiting iconic Dubai landmarks like Museum of the Future",
    offset: true,
  },
  {
    title: "Downtown Dubai",
    tag: "Sightseeing / Iconic",
    img: downtownDubai,
    alt: "Burj Khalifa and Dubai Fountain at twilight",
  },
];
        ...
        <section className="relative h-screen flex flex-col justify-end pb-24 px-6 md:px-10 overflow-hidden">
          <div className="absolute inset-0 z-0 overflow-hidden">
            <div className="w-full h-[120%] -translate-y-[12%] md:h-full md:translate-y-0">
              <img
                src={dubai1}
                alt="Aerial view of Dubai Marina at sunset with luxury yachts"
          ...
          <div className="relative z-10 max-w-5xl">
            <span className="eyebrow text-accent block mb-8 reveal hidden md:block">
              Cloud Life Travels · Est. Dubai
            </span>
            <h1 className="font-serif text-[clamp(4rem,11vw,9rem)] leading-[0.85] text-white italic mb-10 reveal reveal-delay-1">
              World <br />
              <span className="not-italic">Awaits.</span>
            </h1>
            <div className="flex flex-col md:flex-row gap-10 items-start reveal reveal-delay-2">
              ...
              <Link
                to="/contact"
                className="bg-accent text-brand px-10 py-5 text-[10px] uppercase tracking-[0.25em] font-bold hover:brightness-110 transition-all whitespace-nowrap"
              >
                Plan Your Journey
              </Link>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-baseline mb-20 gap-8">
              ...
              <p className="text-brand/60 text-sm max-w-xs font-light">
                Our activities are hand-selected for authenticity, exclusivity, and that rare sense
                of wonder.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {activities.map((a) => (
                <Link
                  to="/dubai-activities"
                  key={a.title}
                  className={`group block ${a.offset ? "md:mt-16" : ""}`}
                >
        ...
        <section className="bg-brand text-white py-32 px-6 md:px-10">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-24 items-center">
            <div>
              ...
              <h2 className="font-serif text-5xl md:text-6xl mb-10 leading-[0.95]">
                Seamless transitions <br />
                <span className="italic opacity-70 font-light">to the Emirates</span>
              </h2>
                ...
                {[
                  {
                    n: "01",
                    t: "UAE Tourist Visas",
                    d: "48 & 96 hrs transit visas, 30 & 60 days single/multiple entry visas, with 24/7 support.",
                  },
                  {
                    n: "02",
                    t: "Visa change and extensions",
                    d: "By flight / By bus / Inside country",
                  },
                  {
                    n: "03",
                    t: "GCC and Global Tourist Visas",
                    d: "Oman, Qatar, KSA, Bahrain, Kuwait and all other international countries",
                  },
                ].map((s, i, arr) => (
                  <div
                    key={s.n}
                    className={`flex gap-6 ${i < arr.length - 1 ? "border-b border-white/10 pb-8" : ""}`}
                  >
              ...
              <Link
                to="/visas"
                className="inline-block mt-12 eyebrow text-accent border-b border-accent/40 pb-2 hover:border-accent"
              >
            ...
            <div className="relative">
              <img
                src={passport}
                alt="Luxury passport holder on marble"
                loading="lazy"
              ...
              <div className="absolute -bottom-8 -left-8 bg-accent text-brand p-10 hidden md:block max-w-xs">
                <p className="font-serif text-2xl italic leading-tight">
                  "Everything was handled before I even landed."
                </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-end mb-16 gap-8">
              <div>
                ...
                <h2 className="font-serif text-5xl md:text-7xl leading-[0.95]">
                  The world, <span className="italic">unfolded</span>.
                </h2>
              </div>
              <Link
                to="/tour-packages"
                className="eyebrow text-brand/60 hover:text-accent hidden md:block"
              >
                View all →
              </Link>
            </div>
                ...
                >
                  ...
                  <div className="md:w-1/2 p-4 sm:p-6 md:p-8 flex flex-col justify-between">
                    <div>
                      ...
                      <h3 className="font-serif text-base sm:text-2xl italic mb-1.5 sm:mb-3 leading-tight text-white">
                        {h.title}
                      </h3>
                      ...
                      <div className="space-y-1.5 sm:space-y-2 mb-4 sm:mb-8">
                        {h.inclusions.map((inc, i) => (
                          <div
                            key={i}
                            className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-[12px] text-white/70 font-sans font-light"
                          >
        ...
        <section className="bg-canvas py-32 px-6 md:px-10 border-t border-brand/10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="font-serif text-4xl md:text-6xl italic leading-[1.05] text-brand">
              "Travel, when done well, is not movement — it is transformation measured in quiet
              mornings and improbable horizons."
            </p>
            <Link
              to="/contact"
              className="inline-block mt-16 bg-brand text-canvas px-12 py-5 eyebrow hover:bg-accent hover:text-brand transition-all"
            >
              Begin Your Journey
            </Link>
          </div>
